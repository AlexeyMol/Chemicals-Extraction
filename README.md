Проект: Обработка химических структур
Этот проект предназначен для обработки химических структур. Он содержит функции для получения Inchi кодов для химических структур, сохранения химических структур в mol файлы и стандартизации mol файлов.
